...
export default class Blogfilter extends Component {
	...
	ShowArrow = () => {
		return this.state.checked ? <i class="fas fa-chevron-down"></i> : <i class="fas fa-chevron-up"></i>
	}
	render() {
		return (
					...
					<div class="panel">
						<div className="flex-items">
							...
							<div className="article-wrapper">
								<div className="blog_date-wrapper">
									<div>
										<span className="blog-to-have-space">EVENT PLANNING & PROMOTION</span>
									</div>
									<div>
						...
						<div className="flex-items">
							...
							<div className="article-wrapper">
								<div className="blog_date-wrapper">
									<div>
										<span className="blog-to-have-space">STORIES AND INTERVIEWS</span>
									</div>
									<div>
										<span style={{ color: "#A7A9B6" }}>SEPT 22</span>
								...
								<div>
									<span className="brief">
										...
										Prioritizing Safety and Communication <br></br> Are Key to Resuming In-Person Events
																		</span>
								</div>
							</div>
						...
						<div className="flex-items">
							...
							<div className="article-wrapper">
								<div className="blog_date-wrapper">
									<div>
										<span className="blog-to-have-space">RESOURCES AND TOOLS</span>
									</div>
									<div>
										<span style={{ color: "#A7A9B6" }}>SEPT 22</span>
				...
				<section className="bannerlog" >
					...
					<div className="bannerblog2 ">
						...
						<div className="bring-it-down">
							<h3>
								Get started with RM in minutes
							</h3>
							<h5 className="bannerblog3">
								Create a beautiful event listing and easily drive attendance with <br></br> built-in tools.
							</h5>
					...
					<div class="panel">
						<div className="flex-items">
							...
							<div className="article-wrapper">
								...
								<div>
									<span className="brief">
										How to Work With Celebrities and Big-Name<br></br> Talent for Virtual Events
																		</span>
								</div>
							</div>
