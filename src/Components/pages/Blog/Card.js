			...
			<div  className="general-container"> 
				<div class="panel">
					...
					<div className="flex-itemss   line-border">
						...
						<div className="inbox" >
							Get event creator<br></br> insights sent directly<br></br> to your inbox
						</div>
						...
						<span className="policy">
							<p>	By entering your email, you agree to receive this and other marketing content about ways Eventbrite can support your events. You may opt-out of future Eventbrite marketing emails at any time using the unsubscribe link within the email. Read our <Link to="/visit" ><span style={{color:"#F77947"}}>Privacy Policy here</span> </Link>.</p>
						</span>
